...
label0 = Label(root, text="            MY INTERNSHIP RECORDS", font=("Helvetica", 30))
...
label3 = Label(root, text='Domain', font=("Helvetica", 12))
label3.grid(row=8, column=0, sticky=W, padx=10, pady=10)

label4 = Label(root, text='Period', font=("Helvetica", 12))
label4.grid(row=9, column=0, sticky=W, padx=10, pady=10)

label5 = Label(root, text='Experience', font=("Helvetica", 12))
label5.grid(row=10, column=0, sticky=W, padx=10, pady=10)

label6 = Label(root, text='Stipend', font=("Helvetica", 12))
